...
fun List<String>.mapInts(delimiter: Regex = ",".toRegex()): List<List<Int>> {
    return map { it.mapInts(delimiter) }
}

fun List<String>.mapLongs(delimiter: Regex = ",".toRegex()): List<List<Long>> {
    return map { it.mapLongs(delimiter) }
}
